...
st.markdown("""
    ...
    /* Make the DataFrame background semi-transparent */
    .stDataFrame table {
    ...
    /* Set the header text in the table to green */
    ...
    /* Style text input and number input */
...
**Instructions:**
1. Enter a valid User ID (from the dataset).
2. Choose how many recommendations you'd like.
3. Click **Get Recommendations** to see your personalized list!

**Data Disclaimer:**
- The recommendations are based on the given dataset.
- If no unheard songs are available, a message will be shown.

**Credits:**
- UI inspired by music streaming platforms.
...
# Lottie Animation
# =====================================
# Lottie animation URL from lottiefiles (you can choose another animation if desired)
